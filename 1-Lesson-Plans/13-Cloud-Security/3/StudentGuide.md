...
<<<<<<< HEAD:v2.5-Curriculum/1-Lesson-Plans/13-Cloud-Security/3/StudentGuide.md
- `ansible.builtin.apt`: The name of the module we are using. It is at the same indentation level as the `name` specification.
=======
- `anisble.builtin.apt`: The name of the module we are using. It is at the same indentation level as the `name` specification.
>>>>>>> Main:v2.5-Curriculum/01-Lesson-Plans/13-Cloud-Security/3/StudentGuide.md
...
=======
- `ansible.builtin.apt`, found at [docs.ansible.com/ansible/latest/modules/apt_module.html](https://docs.ansible.com/ansible/latest/modules/apt_module.html).
>>>>>>> Main:v2.5-Curriculum/01-Lesson-Plans/13-Cloud-Security/3/StudentGuide.md
